...
const UpdateTeacher = () => {
    ...
    return (
        <div className='my-10'>
            <h1 className='text-3xl font-bold text-center'>Update Data About {teachersInfo.name}</h1>
            <div className='w-1/2 mx-auto my-10'>
                {
                    loading ? <div className="skeleton w-32 h-32"></div> : <img className='w-[300px] mx-auto rounded-3xl' src={updatedPhoto} alt="" />
                }
                {
                    updatedPhoto ? '' : <img className='w-[300px] mx-auto rounded-3xl' src={teachersInfo.photo} alt="" />
                }
                ...
                <form onSubmit={handleSubmit}>
                    <input className="px-4 w-full my-6 outline-none py-3 border-2 focus:border-blue-400 rounded-lg text-slate-500" type="text" defaultValue={teachersInfo.name} placeholder="Teacher Name" name='name' required /> <br />
                    <input className="px-4 w-full mb-6 outline-none py-3 border-2 focus:border-blue-400 rounded-lg text-slate-500 file-input file-input-bordered" type="text" defaultValue={teachersInfo.subject} placeholder="What subject does he teach?" name='subject' required /> <br />
                    <input className="px-4 w-full mb-6 outline-none py-3 border-2 focus:border-blue-400 rounded-lg text-slate-500 file-input file-input-bordered" type="email" defaultValue={teachersInfo?.email} placeholder="Email" name='email' required /> <br />
                    <input className="px-4 w-full mb-6 outline-none py-3 border-2 focus:border-blue-400 rounded-lg text-slate-500 file-input file-input-bordered" type="number" defaultValue={teachersInfo.number} placeholder="Phone Number" name='number' required /> <br />
                    {
